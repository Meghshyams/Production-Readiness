...
### 11.1 Prompt Injection Surfaces
...
### 11.2 Secret & PII Leakage into Prompts
...
### 11.3 Untrusted Output Handling
...
### 11.6 AI Endpoint Reliability & Error Handling
...
### 11.7 AI Observability & Abuse Controls
...
- Verify that logged prompts/completions don't persist secrets or PII (ties to 5.5 and 11.2).
